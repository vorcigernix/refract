...
public final class KeyboardLayoutSet {
    ...
    public static final class Builder {
        ...
        public Builder(final Context context, @Nullable final EditorInfo ei) {
            ...
            // Before first unlock, keep settings and other credential-protected features hidden.
            // be locked down.
        ...
        public Builder setSubtype(@NonNull final RichInputMethodSubtype subtype) {
            final boolean asciiCapable = InputMethodSubtypeUtils.isAsciiCapable(subtype);
