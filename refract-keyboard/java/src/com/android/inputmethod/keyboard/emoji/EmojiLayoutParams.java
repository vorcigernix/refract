...
final class EmojiLayoutParams {
    ...
    public EmojiLayoutParams(final Context context) {
        ...
        mKeyVerticalGap = (int) res.getFraction(R.fraction.config_key_vertical_gap_refract,
                defaultKeyboardHeight, defaultKeyboardHeight);
        mBottomPadding = (int) res.getFraction(R.fraction.config_keyboard_bottom_padding_refract,
                defaultKeyboardHeight, defaultKeyboardHeight);
        mTopPadding = (int) res.getFraction(R.fraction.config_keyboard_top_padding_refract,
                defaultKeyboardHeight, defaultKeyboardHeight);
        mKeyHorizontalGap = (int) (res.getFraction(R.fraction.config_key_horizontal_gap_refract,
