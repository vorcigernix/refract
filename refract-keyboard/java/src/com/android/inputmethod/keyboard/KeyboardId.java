...
public final class KeyboardId {
    ...
    public static String actionName(final int actionId) {
        if (actionId == InputTypeUtils.IME_ACTION_CUSTOM_LABEL) {
            return "actionCustomLabel";
        }
        switch (actionId & EditorInfo.IME_MASK_ACTION) {
        case EditorInfo.IME_ACTION_UNSPECIFIED: return "actionUnspecified";
        case EditorInfo.IME_ACTION_NONE: return "actionNone";
        case EditorInfo.IME_ACTION_GO: return "actionGo";
        case EditorInfo.IME_ACTION_SEARCH: return "actionSearch";
        case EditorInfo.IME_ACTION_SEND: return "actionSend";
        case EditorInfo.IME_ACTION_NEXT: return "actionNext";
        case EditorInfo.IME_ACTION_DONE: return "actionDone";
        case EditorInfo.IME_ACTION_PREVIOUS: return "actionPrevious";
        default: return "actionUnknown(" + actionId + ")";
        }
    }
}
