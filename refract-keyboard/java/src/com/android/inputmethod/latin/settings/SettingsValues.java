...
public class SettingsValues {
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        // Refract does not provide voice input. Keeping LatinIME's inherited microphone in the
        // suggestion strip creates a dead, visually detached control and implies audio handling
        // that the product intentionally does not have.
