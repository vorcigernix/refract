...
import com.android.inputmethod.latin.utils.InputMethodSubtypeUtils;
...
public class RichInputMethodSubtype {
    ...
    public RichInputMethodSubtype(@NonNull final InputMethodSubtype subtype) {
        mSubtype = subtype;
        mOriginalLocale = InputMethodSubtypeUtils.getLocaleObject(mSubtype);
    ...
    private static final RichInputMethodSubtype PLACEHOLDER_NO_LANGUAGE_SUBTYPE =
            new RichInputMethodSubtype(InputMethodSubtypeUtils.newInputMethodSubtype(
    ...
    private static final RichInputMethodSubtype PLACEHOLDER_EMOJI_SUBTYPE = new RichInputMethodSubtype(
            InputMethodSubtypeUtils.newInputMethodSubtype(
