...
public final class InputLogic {
            ...
            if (mConnection.hasSelection()) {
                ...
                if (inputTransaction.mSettingsValues.mInputAttributes.isTypeNull()
                        || Constants.NOT_A_CURSOR_POSITION
                                == mConnection.getExpectedSelectionEnd()) {
                    // TYPE_NULL fields expect key events. The cursor-position fallback also leaves
                    // deletion to the editor when its reported selection is unusable.
    ...
    static SuggestedWords retrieveOlderSuggestions(final SuggestedWordInfo typedWordInfo,
        ...
        return new SuggestedWords(typedWordAndPreviousSuggestions, typedWordInfo,
    ...
    private CharSequence getTextWithUnderline(final String text) {
        if (!mIsAutoCorrectionIndicatorOn || TextUtils.isEmpty(text)) {
            return text;
        }
        final SpannableString spannable = new SpannableString(text);
        final SuggestionSpan span = new SuggestionSpan(
                mLatinIME,
    ...
    private void commitChosenWord(final SettingsValues settingsValues, final String chosenWord,
        ...
        // b/21926256
        //      add a SuggestionSpan to chosenWord,
