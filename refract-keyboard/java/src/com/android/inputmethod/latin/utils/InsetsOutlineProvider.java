...
/** Clips the IME window outline to its current visible top inset. */
public final class InsetsOutlineProvider extends ViewOutlineProvider {
    private final View mView;
    private static final int NO_DATA = -1;
    private int mLastVisibleTopInsets = NO_DATA;

    private InsetsOutlineProvider(final View view) {
        mView = view;
    }

    public static InsetsOutlineProvider attach(final View view) {
